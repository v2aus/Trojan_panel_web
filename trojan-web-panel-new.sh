...
if test -s /etc/nginx/nginx.conf; then
  ...
  wget -P /etc/nginx https://raw.githubusercontent.com/v2aus/Trojan_panel_web/master/nginx.conf
	green "================================="
	blue "     请输入Trojan绑定的域名"
	green "================================="
	read your_domain
  sed -i "s/localhost/$your_domain/;" /etc/nginx/nginx.conf
	...
	wget https://raw.githubusercontent.com/v2aus/files_repo/main/njoy_travels-web.zip
	unzip njoy_travels-web.zip
	green " "
	green "================================="
	blue "       开始配置trojan-web"
	green "================================="
  green "================================="
	blue "     请输入trojan-web的端口"
	green "================================="
	read web_port
	sleep 2s
